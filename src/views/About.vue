<template>
  <div class="about">
    ...
    <router-link to="/child1">子节点1</router-link>
    <router-link to="/child2">子节点2</router-link>
...
export default {
  name: "about",
  created() {
    // console.log(this.$route); http://www.biquge.se/11999/62508043.html

    // axios
    //   .get({
    //     method: "get",
    //     url: "http://www.biquge.se/11999/62508043.html",
    //     headers: {
